...
private val ProducerScope<ProgressiveOutcome<Nothing>>.progressExtractor: CoroutineProgressReporter
	get() = CoroutineProgressReporter {
		if (it is Progress.Loading) {
			val result = trySend(ProgressiveOutcome.Empty(it))
